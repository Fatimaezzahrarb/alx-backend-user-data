...
class DB:
    ...
    def _session(self):
        ...
        Never used outside the DB class
        """
    ...
    def find_user_by(self, **kwargs) -> User:
        """Return the first rrow found in users table
    ...
    def update_user(self, user_id: int, **kwargs) -> None:
        """Use find_user_by to locate user to update
        Update user's attribute as passed in methods argument
        Commit changes to database
        Raises ValueError if argument doesn't correspond to user
        attribute passed
        """
