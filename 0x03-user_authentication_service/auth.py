#!/usr/bin/env python3
"""Auth Class for the user attributes validation
"""
...
def _hash_password(password: str) -> str:
    ...
    Return the bytes (salted_hashed)
    """
    return bcrypt.hashpw(password.encode('utf-8'), bcrypt.gensalt())


def _generate_uuid() -> str:
    """Return the string repr of a new UUID
    Use uuid module
    """
...
class Auth:
    ...
    def register_user(self, email: str, password: str) -> User:
        ...
        Raise the ValueError if exists
    ...
    def valid_login(self, email: str, password: str) -> bool:
        """Expect the email and password required arguments
        Returns a boolean
        """
        try:
    ...
    def create_session(self, email: str) -> str:
        """Take the email string argument
        Return session ID as a string
        Find the user corresponding to email, generate new UUID
    ...
    def get_user_from_session_id(self, session_id: str) -> str:
        """Take single session_id string argument
    ...
    def get_reset_password_token(self, email: str) -> str:
        """Take the email string argument, Return string
        Find the user corresponding to email, raise ValueError if not exists
        generate uuid and update the users reset_token database field
